...
#all steps of machine learning 
 ...
 # E train the model use for example 75 % of the data to train the moddle and 25 % to test if it works 
...
#converting all string in to numbers 
...
#SPLITINNG the data set in to training and testing 
